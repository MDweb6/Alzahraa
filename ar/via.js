...
let veckodagar = ["الأحد", "الاثنين", "الثلاثاء", "الأربعاء", "الخميس", "الجمعة", "السبت"];
let veckodag = veckodagar[dagen];
  ...
  if(dgr == 1){
    DuaRubrik.innerText = `دعاء ${veckodagar[dgr]} `
